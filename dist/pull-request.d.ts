...
export declare class PullRequest {
     ...
     */
    constructor(number: undefined, sha: undefined, context: CustomContext, octokit: CustomOctokit);
    constructor(number: number, sha: string, context: CustomContext, octokit: CustomOctokit);
